...
dir = "C:/Workspace/chungvodim/dataset/traffic_video"
cap = cv2.VideoCapture(f"{dir}/sample_1.mp4")
...
out = cv2.VideoWriter(f'{dir}/sample_1_output.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (frame_width, frame_height))
